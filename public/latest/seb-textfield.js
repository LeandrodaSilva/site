import{s as e,i as t,_ as i,n as o,x as s}from"./48f1a509.js";class a extends e{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.button=!1,this.required=!1,this.firstSubmit=!1,this.name="",this.value="",this.searchValue="",this.label="Label"}connectedCallback(){super.connectedCallback(),window.addEventListener("seb-button-submit",(e=>this.firstSubmit=!0))}disconnectedCallback(){window.removeEventListener("csat.submit",(()=>{this.firstSubmit=!1})),super.disconnectedCallback()}__handleClick(){this.checked=!this.checked}__handleFocus(){var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("span"))||void 0===t||t.classList.add("focus")}__handleBlur(e){var t,i;const o=e.target;("cf_ptr_telefonecelular"===o.name&&this.value.startsWith("+55")&&this.value.length<19||"cf_ptr_telefonealuno"===o.name&&this.value.startsWith("+55")&&this.value.length<19)&&(o.value=""),("cf_ptr_datadenascimentoaluno"===o.name&&this.value.length<10||"cf_ptr_nascimentoresponsavel"===o.name&&this.value.length<10)&&(o.value=""),null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("span"))||void 0===i||i.classList.remove("focus"),this.__handleInput(e),this.dispatchEvent(new InputEvent("input"))}__handleKeydown(e){"Backspace"===e.key&&this.__handleInput(e)}__handleInput(e){if(this.button)return this.value="",void(e.target.value="");const t=e.target;"cf_ptr_horaagenda"!==this.name&&"cf_ptr_dataagenda"!==this.name?("cf_ptr_telefonecelular"===this.name||"cf_ptr_telefonealuno"===this.name)&&t.value.startsWith("+55")&&(e instanceof KeyboardEvent&&"Backspace"===e.key&&(e.preventDefault(),t.value.length>4&&(t.value=t.value.slice(0,-1))),t.value.length>=15&&t.value.length>19)?t.value=t.value.slice(0,19):this.value=t.value:t.value=this.value}render(){var e;return s`
      <label>
